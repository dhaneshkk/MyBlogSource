...
feedConfiguration title = FeedConfiguration
    { feedTitle       = "dhanesh - " ++ title
    , feedDescription = "Personal blog of dhanesh"
    , feedAuthorName  = "Dhanesh Kasinathan"
    , feedAuthorEmail = "dhaneshkk@gmail.com"
    , feedRoot        = "http://dhaneshkk.github.io"
    }
